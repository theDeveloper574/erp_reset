...
//
//     final specficContactModel = specficContactModelFromJson(jsonString);

import 'dart:convert';

SpecficContactModel specficContactModelFromJson(String str) =>
    SpecficContactModel.fromJson(json.decode(str));

String specficContactModelToJson(SpecficContactModel data) =>
    json.encode(data.toJson());

class SpecficContactModel {
  SpecficContactModel({
    this.data,
  });
  ...
  factory SpecficContactModel.fromJson(Map<String, dynamic> json) =>
      SpecficContactModel(
