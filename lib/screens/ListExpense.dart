...
class EMList extends StatefulWidget {
  @override
  _EMListState createState() => _EMListState();
}

class _EMListState extends State<EMList> {
    ...
    if (_expenseList == null) {
      ...
      for (var i = 0; i < _expenseList.data.length; i++) {
        if (_expenseList.data[i].paymentStatus != null) {
          if (_statusList.contains(_expenseList.data[i].paymentStatus)) {
          } else {
