...
final String productApi = 'product';
final String ledgerApi = 'contact/17/ledger';
final String locationApi = 'business-location';
final String expenseApi = 'expense';
final String contactApi = 'contactapi';
